...
%		Degree Programme:&  MPhys Physics with Astronomy \\
...
\text{\emph{Secondary Assessor}}&: \text{Dr. Clarence C. \textsc{Matthai}} \\
\end{align*}
...
\begin{figure}
	...
	\centering
	\caption{\cite{noisecurve}Noise curve for advanced LIGO detectors.}
	\centering
\end{figure}
