...
#### WHERE WE EXECUTE THE CODES
## Run1 specific parameters
savename="/home/c1265898/LIGO-Project-Codes/Matching/2D_data/phase_s20psi1"
psi_1=0.
psi_2=0.
...
data[2]=final
data[3]=specs
pickle.dump(data,open("%s.p" % savename,"wb"))
print "Data saved as %s" % savename

## Run2 specific parameters
savename="/home/c1265898/LIGO-Project-Codes/Matching/2D_data/phase_s20psi2"
psi_1=0.52359878
psi_2=0.52359878
# Run and save
final=spinLimit(inc,spin1,mass2Values)
...
pickle.dump(data,open("%s.p" % savename,"wb"))
print "Data saved as %s" % savename
## Run3 specific parameters
savename="/home/c1265898/LIGO-Project-Codes/Matching/2D_data/phase_s20psi3"
psi_1=1.04719755
psi_2=1.04719755
# Run and save
final=spinLimit(inc,spin1,mass2Values)
...
pickle.dump(data,open("%s.p" % savename,"wb"))
print "Data saved as %s" % savename
## Run4 specific parameters
savename="/home/c1265898/LIGO-Project-Codes/Matching/2D_data/phase_s20psi4"
psi_1=1.57079633
psi_2=1.57079633
# Run and save
final=spinLimit(inc,spin1,mass2Values)
